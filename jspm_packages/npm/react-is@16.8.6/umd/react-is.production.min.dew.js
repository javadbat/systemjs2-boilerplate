...
export function dew() {
  ...
  (function (b, c) {
    "object" === typeof exports && true ? c(exports) : "function" === typeof define && define.amd ? define(["exports"], c) : c(b.ReactIs = {});
  })(exports, function (b) {
    function c(a) {
    ...
    b.isValidElementType = function (a) {
      return "string" === typeof a || "function" === typeof a || a === f || a === e || a === g || a === h || a === k || "object" === typeof a && null !== a && (a.$$typeof === p || a.$$typeof === q || a.$$typeof === n || a.$$typeof === l || a.$$typeof === m);
    };

...
import { dew as _checkPropTypesDewDew } from "prop-types/checkPropTypes.dew.js";
...
export function dew() {
  ...
  if (process.env.NODE_ENV !== "production") {
    (function () {
      ...
      var _assign = _indexDewDew();

      var checkPropTypes = _checkPropTypesDewDew(); // TODO: this is special because it gets imported during build.
